...
for alpha in alphas:
    ...
    accuracy, _ = train_and_evaluate(prior_probs, train_data, test_data, alpha)
...
prior_probs = train_data['screen_name'].value_counts(normalize=True).to_dict()
